...
public class TemplateSlotMUC {
	...
	private static void addDoc(DocFeatures docFeatures) {
		...
		for (InstanceFeatures instance : docFeatures.getInstances()) { 
			...
			if (instance.getInverseFeatures() != null) { 
				inverseFeatureLists = String2IntegerFeatures.get (instance.getInverseFeatures() , template1) ; 
			}
	...
	private static void inferTemplates () throws Exception {
		...
		mlhdpData.addComponent(1, 2 , template1.getNumOfValues(2)  , parms.betaS) ; 
